        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box text-center">
                <a href="" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('assets/images/favicon.png') }}" alt="logo-sm-dark" style="width: 50px; height: 50px;">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/logo-dark.png') }}" alt="logo-dark" style="width: 200px; height: 50px;">
                    </span>
                </a>
                ...
                <a href="" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/logo-light.png') }}" alt="logo-light" style="width: 200px; height: 50px;">
                    </span>
                </a>
            </div>
